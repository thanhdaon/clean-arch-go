...
| Use Case | Status | Endpoint | Description |
|----------|--------|----------|-------------|
...
| AddTaskDescription | ✅ | `PATCH /api/tasks/{taskId}/description` | Add or update task description |
...
**Implemented:** 17 use cases  
**Not Implemented:** 45 use cases
